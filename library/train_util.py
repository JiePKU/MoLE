...
def load_tokenizer(args: argparse.Namespace):
    ...
    if tokenizer is None:
        if args.v2:
            ...
            "./stable-diffusion-v1-5", subfolder="tokenizer", revision=None)
    ...
    with torch.no_grad():
        with accelerator.autocast():
            for i, prompt in enumerate(prompts):
                ...
                negative_prompt = " poor quality, unclear hand, bad face " ## , 
                ...
                image = pipeline(
                    prompt=prompt + "best quality, 8K, good face, clear hand",
                    height=height,
                    width=width,
