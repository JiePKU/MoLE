...
class LoRAModule(torch.nn.Module):
    ...
    def __init__(
        ...
        if org_module.__class__.__name__ == "Conv2d":
            ...
            out_dim = org_module.out_features  # linear layer
    ...
    def apply_to(self):
        ...
        del self.org_module  # for moe do not remove
...
class LoRANetwork(torch.nn.Module):
                    ...
                    for child_name, child_module in module.named_modules():
                        ...
                        if is_linear or is_conv2d_1x1:
                            ...
                            if lora_name in names:
                                ...
                                # if is_conv2d:
                                #     print("conv",child_module.kernel_size, lora_name)
                                # if is_linear:
                                #     print("linear",lora_name)
                                names.add(lora_name)
                            dim = None
                            alpha = None
                            if modules_dim is not None:
    ...
    def apply_to(self, text_encoder, unet, apply_text_encoder=True, apply_unet=True, apply_to=True):
