...
export DATASET_NAME="./data_config/test_1.toml"
...
OMP_NUM_THREADS=1 $PYTHON -m torch.distributed.launch --nproc_per_node 2 \
    ...
    --full_bf16 \
    --dim_from_weights \
    --network_weights "/root/paddlejob/workspace/env_run/output/sd-scripts-xl/sd_output/lora_sdxl_hand_llavacap_60k-lr1e-5-d256/lora_sdxl_hand_llavacap_60k-lr1e-5-d256-step00020000.safetensors" \
    # --mem_eff_attn \
    # --xformers \
    # --noise_offset 0.07 \
